...
public class ManageStudents extends javax.swing.JFrame {
    ...
    //to provide student details to table
    public boolean addStudent(){
        boolean isAdded=false;
        
        student_id=Integer.parseInt(txt_studentid.getText());
        student_name=txt_stdentname.getText();
    ...
    public boolean updateStudent(){
        ...
        try{
            Connection con = DBConnection.getConnection();
            PreparedStatement pst= con.prepareStatement("Update student_details set student_name=?,course_name=?,branch=? where student_id = ?");
    ...
    private void initComponents() {
        ...
        txt_stdentname = new javax.swing.JTextField();
        ...
        jPanel1.add(txt_studentid, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 320, -1));

        txt_stdentname.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_stdentnameFocusLost(evt);
            }
        });
        txt_stdentname.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_stdentnameActionPerformed(evt);
            }
        });
        jPanel1.add(txt_stdentname, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, 320, -1));
        ...
        txt_branch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DS", "CS", "SE", "EE", " ", " " }));
        jPanel1.add(txt_branch, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 320, -1));

        txt_course.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSC", "MSC", "PHD", " " }));
        jPanel1.add(txt_course, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 320, -1));
        ...
        tbl_studentDetails.setForeground(java.awt.Color.darkGray);
        ...
        tbl_studentDetails.setColorFilasBackgound1(new java.awt.Color(255, 153, 153));
        tbl_studentDetails.setColorFilasBackgound2(new java.awt.Color(255, 153, 153));
        ...
        tbl_studentDetails.setFuenteFilasSelect(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
    ...
    private void txt_stdentnameFocusLost(java.awt.event.FocusEvent evt) {                                         
        // TODO add your handling code here:
    }                                        

    private void txt_stdentnameActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(deleteStudent()==true){
            JOptionPane.showMessageDialog(this, "Student deleted succecfully.");
            clearTable();
            SetStudentDetailsToTable();
        }else{
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(updateStudent()==true){
            JOptionPane.showMessageDialog(this, "Student updated succecfully.");
            clearTable();
            SetStudentDetailsToTable();
        }else{
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(addStudent()==true){
            JOptionPane.showMessageDialog(this, "Student Added succecfully.");
            clearTable();
            SetStudentDetailsToTable();
        }else{
    ...
    private void tbl_studentDetailsMouseClicked(java.awt.event.MouseEvent evt) {                                                
        ...
        txt_stdentname.setText(model.getValueAt(rowNo,1).toString());
    ...
    private javax.swing.JTextField txt_stdentname;
